...
fun homecleaning(navController: NavHostController) {
    ...
    Column(modifier= Modifier.fillMaxSize()) {
        ...
        Box(modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) {
            //Lottie Animation
            val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(R.raw.housekeeping))
        ...
        Text(text = "We are a well-known cleaning services company, and we take pride in delivering customer satisfaction every time with our cleaning services.",
            modifier = Modifier.fillMaxWidth(),
            textAlign = TextAlign.Center,
            fontSize = 20.sp)

...
class   ProductViewModel(var navController:NavHostController, var context: Context) {
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = com.example.firebasestorage.models.Product(name,quantity,price,imageUrl,productId)
    ...
    fun allProducts(
        ...
        products:SnapshotStateList<com.example.firebasestorage.models.Product>):SnapshotStateList<com.example.firebasestorage.models.Product>{
        progress.show()
        ...
        ref.addValueEventListener(object: ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children){
                    var retrievedProduct = snap.getValue(com.example.firebasestorage.models.Product::class.java)
